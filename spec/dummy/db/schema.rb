...
ActiveRecord::Schema.define(version: 2020_10_07_126098) do
  ...
  create_table "spree_users", force: :cascade do |t|
    ...
    t.index ["refer_token"], name: "index_spree_users_on_refer_token", unique: true
    t.index ["referred_by_id"], name: "index_spree_users_on_referred_by_id"
